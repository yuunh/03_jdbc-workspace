...
import com.kh.netflix.model.service.NetflixService;
...
public class NetflixController {
	...
	public void insertMember(String id, String level, String nickName, int point) {
		...
		int result = new NetflixService().insertMember(n);
	...
	public void selectList() {
		...
		ArrayList<Netflix> list = new NetflixService().selectList();
	...
	public void selectId(String Id) {
		...
		Netflix n = new NetflixService().selectId(Id);
	...
	public void selectNickName(String keyword) {
		...
		ArrayList<Netflix> list = new NetflixService().selectNickName(keyword);
	...
	public void updateMember(String id, String level, String nickName, int point) {
		...
		int result = new NetflixService().updateMember(n);
	...
	public void deleteMember(String id) {
		...
		int result = new NetflixService().deleteMember(id);
